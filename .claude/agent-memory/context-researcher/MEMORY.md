...
- [project_ble_gateway_architecture.md](project_ble_gateway_architecture.md) — ADR-003
  BLE gateway decision, PM5 single-connection finding, c2m-ooz.3 relay: software done +
  2 hardware runs, only c2m-ooz.3.3 (re-verify) left open
...
- [project_python_app_not_started.md](project_python_app_not_started.md) — the actual
